...
<CaseStudyVideo src="/videos/ibm-codb-walkthrough.mp4" title="Walkthrough of the Cost of a Data Breach interactive calculator" autoplay muted loop />
...
The experience was designed mobile-first throughout — from the personalised calculator to the data security readiness assessment and the lead capture flows that converted interest into pipeline.

<ImageGrid
  images={[
    { src: '/images/ibm-codb-mobile-gauge.jpg', alt: 'Cost of a Data Breach mobile calculator with breach cost gauge' },
    { src: '/images/ibm-codb-assessment.jpg', alt: 'Data security readiness assessment on mobile' },
    { src: '/images/ibm-codb-register.jpg', alt: 'Report download and lead capture flow on mobile' },
  ]}
  caption="The mobile experience: personalised calculator, readiness assessment, and lead capture."
/>
